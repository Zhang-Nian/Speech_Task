...
CXXFLAGS = -std=c++11 -I.. -isystem -O2 $(EXTRA_CXXFLAGS) \
...
LDLIBS = $(EXTRA_LDLIBS) $(MKLFLAGS) -lm -lpthread -ldl
MKLFLAGS = -L/opt/intel/mkl/lib/intel64 -Wl,-rpath=/opt/intel/mkl/lib/intel64 -lmkl_intel_lp64  -lmkl_core  -lmkl_gnu_thread    -lgomp -ldl -lpthread -lm 

ifndef DOUBLE_PRECISION
$(error DOUBLE_PRECISION not defined.)
endif

CXXFLAGS += -fPIC -pthread -isystem 
