...
WebRtcVadFilterBank::WebRtcVadFilterBank()
{
...
void WebRtcVadFilterBank::WebRtcVad_HpOutput(int16_t* in_vector,
...
void WebRtcVadFilterBank::WebRtcVad_Allpass(int16_t* in_vector,
...
void WebRtcVadFilterBank::WebRtcVad_SplitFilter(int16_t* in_vector,
                           int in_vector_length,
                           int16_t* upper_state,
                           int16_t* lower_state,
...
int16_t WebRtcVadFilterBank::WebRtcVad_get_features(VadInstT* inst,
                               int16_t* in_vector,
                               int frame_size,
                               int16_t* out_vector) {
  int16_t power = 0;
...
void WebRtcVadFilterBank::WebRtcVad_LogOfEnergy(int16_t* vector,
                           int vector_length,
                           int16_t offset,
                           int16_t* power,
                           int16_t* log_energy) {
  ...
  int32_t energy = SignalProcessing::GetInstance()->WebRtcSpl_Energy(vector, vector_length, &shfts);
