...
int32_t WebRtcVadGMM::WebRtcVad_GaussianProbability(int16_t input,
                                                    int16_t mean,
                                                    int16_t std,
                                                    int16_t* delta) 
{
  ...
  inv_std = (int16_t) SignalProcessing::GetInstance()->WebRtcSpl_DivW32W16(tmp32, std);
